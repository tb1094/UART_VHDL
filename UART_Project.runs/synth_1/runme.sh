...
HD_PWD='C:/praksa/UART_Project/UART_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TX_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TX_TEST.tcl
