...
HD_PWD='C:/praksa/UART_Project/UART_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TX_TEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TX_TEST.tcl -notrace
